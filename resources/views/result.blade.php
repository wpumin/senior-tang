                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12 px-0">
                                <p class="text-white py-3 pb-md-4"><i class="flaticon-pointer"></i> <span
                                        class="strong">เส้นทาง: </span><span
                                        class="d-block pt-4 pt-md-0 d-md-inline-block text-center text-md-left">
                                        เกาะเชือก, เกาะมุกต์, เกาะไหง, เกาะแหวน</span> </p>
                                <p class="text-white py-3 pb-md-4"><i class="flaticon-dashboard"></i> <span
                                        class="strong">ระยะทาง:</span> 43.52 กม.</p>
                                <p class="text-white py-3 pb-md-4"><i class="flaticon-clock"></i> <span
                                        class="strong">เวลาที่ใช้:</span> 2 ชั่วโมง 25 นาที</p>
                                <hr style="border-top: 1px solid rgba(255,255,255,.25);" class="d-block d-md-none">
                                <p class="text-white py-3 pb-md-4 text-left text-md-right"> <span
                                        class="strong">ข้อมูลเมื่อ:</span> <span id="time"></span> </span></p>
                            </div>
                        </div>
                    </div>
                </div>
