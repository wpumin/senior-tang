...
(function (factory) {
    ...
    $.fn.fileinputLocales.en = {
        ...
        msgNo: 'No',
        msgNoFilesSelected: 'เกิดข้อผิดพลาดในการอัพโหลดไฟล์',
        msgCancelled: 'Cancelled',
        msgPlaceholder: 'Select {files}...',
        msgZoomModalHeading: 'Detailed Preview',
        msgFileRequired: 'You must select a file to upload.',
        msgSizeTooSmall: 'File "{name}" (<b>{size} KB</b>) is too small and must be larger than <b>{minSize} KB</b>.',
        msgSizeTooLarge: 'ไฟล์ "{name}" (<b>{size} KB</b>) ขนาดไฟล์ใหญ่กว่า <b>{maxSize} KB</b>.',
        msgFilesTooLess: 'You must select at least <b>{n}</b> {files} to upload.',
        msgFilesTooMany: 'จำนวนไฟล์ที่คุณต้องการอัพโหลดคือ <b>{n}</b> ไฟล์ แต่ระบบรองรับเพียง <b>{m}</b> ไฟล์เท่านั้น.',
        ...
        msgInvalidFileExtension: 'ไฟล์ของคุณคือ "{name}". แต่ระบบรองรับเพียงไฟล์ "{extensions}" เท่านั้น.',
        msgFileTypes: {
            'image': 'image',
            'html': 'HTML',
            'text': 'text',
        ...
        msgUploadThreshold: 'กำลังประมวลผล...',
        msgUploadBegin: 'กำลังประมวลผล...',
        msgUploadEnd: 'สำเร็จ',
        msgUploadEmpty: 'No valid data available for upload.',
        msgUploadError: 'เกิดข้อผิดพลาด',
